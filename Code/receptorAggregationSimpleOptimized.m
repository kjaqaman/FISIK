function [receptorInfoAll,receptorInfoLabeled,timeIterArray,errFlag] ...
    = receptorAggregationSimpleOptimized(modelParam,simParam)
%RECEPTORAGGREGATIONSIMPLEOPTIMIZED simulates the free diffusion and interactions of molecules in 2D
%
...
% Modified 2018/09/18 Luciana de Oliveira
% Modified 2018/10/18 Luciana de Oliveira - Now the aggregation is
%             calculated based only on the corrected distance.
% Modified 2018 Nov 29- Devin O'Kelly
%           - Changed receptor/cluster mapping to utilize accumarray
%           instead of looping.
%
